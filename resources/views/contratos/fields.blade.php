<div class="container formulario-padrao">
    ...
    <div class="row">
        ...
        <p class="col-xs-12 col-sm-6">{!! Form::text('NomeContrato', null, ['class' => 'form-control']) !!}</p>
    </div>
    <!-- Idcurso Field -->
    <div class="row">
        <p class="col-xs-12 col-sm-3">{!! Form::label('idCurso', 'ID do Curso:') !!}</p>
        <p class="col-xs-12 col-sm-6">{!! Form::number('idCurso', null, ['class' => 'form-control']) !!}</p>
    </div>

    <!-- Contrato1 Field -->
    <div class="row">
        <p class="col-xs-12 col-sm-3">{!! Form::label('Contrato1', 'Texto do Contrato:') !!}</p>
        <p class="col-xs-12 col-sm-6">{!! Form::textarea('Contrato1', null, ['class' => 'form-control editor1']) !!}</p>
    </div>

    <!-- Assinatura1 Field -->
    <div class="row">
        <p class="col-xs-12 col-sm-3">{!! Form::label('Assinatura1', 'Assinatura:') !!}</p>
        <p class="col-xs-12 col-sm-6">{!! Form::textarea('Assinatura1', null, ['class' => 'form-control editor2']) !!}
        </p>
    </div>
    ...
    <div class="row">
        ...
        <p class="col-xs-12 col-sm-6">{!! Form::textarea('Valores1', null, ['class' => 'form-control editor3']) !!}</p>
    </div>

    <!-- Prestadora Field -->
    <div class="row">
        <p class="col-xs-12 col-sm-3">{!! Form::label('Prestadora', 'Prestadora:') !!}</p>
        <p class="col-xs-12 col-sm-6">{!! Form::textarea('Prestadora', null, ['class' => 'form-control editor4']) !!}
        </p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 input-group col-sm-6" style="padding:5px 15px;">
