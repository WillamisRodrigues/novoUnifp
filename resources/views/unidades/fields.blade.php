...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            <!-- Nomeunidade Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('NomeUnidade', 'Unidade:') !!}<span
            ...
            <!-- Cnpj Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('CNPJ', 'CNPJ:') !!}<span
                        style="color: red">*</span>
                </p>
            ...
            <!-- Endereco Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Endereco', 'Endereço:') !!}<span
                        style="color: red">*</span></p>
                <p class="col-md-9 col-sm-12">{!! Form::text('Endereco', null, ['class' => 'form-control']) !!}</p>
            </div>
            <!-- Bairro Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Bairro', 'Bairro:') !!}<span
                        style="color: red">*</span>
                </p>
            ...
            <!-- Cidade Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Cidade', 'Cidade:') !!}<span
                        style="color: red">*</span>
                </p>
            ...
            <!-- Uf Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('UF', 'UF:') !!}<span
                        style="color: red">*</span></p>
            ...
            <!-- Telefone1 Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12" style="margin-top: 15px">{!! Form::label('Telefone1', 'Telefone
                    1:')
            ...
            <!-- Telefone2 Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12" style="margin-top: 15px">{!! Form::label('Telefone2', 'Telefone
                    2:')
                    !!}</p>
                <p class="col-md-9 col-sm-12">
                    <div class="input-group" style="padding-right: 15px; padding-left: 15px; ">
            ...
            <!-- Tipo Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Tipo', 'Tipo:') !!}<span
                        style="color: red">*</span>
                </p>
                <p class="col-md-9 col-sm-12">
            ...
            <!-- Logotipo Field -->
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Logotipo', 'Logotipo:') !!}<span
                        style="color: red">*</span></p>
        ...
        <div class="tab-pane" id="tab_2">
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Contrato1', 'Texto de Contrato:') !!}<span
                        style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::textarea('Contrato1', null, ['class' => 'form-control editor1']) !!}</p>
            </div>
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Assinatura1', 'Área de Assinatura:') !!}<span
                        style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::textarea('Assinatura1', null, ['class' => 'form-control editor2']) !!}
                </p>
            </div>
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Valores1', 'Valores e Condições de
                    Pagamento:') !!}<span style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::textarea('Valores1', null, ['class' => 'form-control editor3']) !!}</p>
            </div>
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Matricula1', 'Valor da Matrícula:') !!}<span
                        style="color: red">*</span></p>
        ...
        <div class="tab-pane" id="tab_3">
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Contrato2', 'Texto de Contrato:') !!}<span
                        style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::textarea('Contrato2', null, ['class' => 'form-control editor4']) !!}</p>
            </div>
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Assinatura2', 'Área de Assinatura:') !!}<span
                        style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::textarea('Assinatura2', null, ['class' => 'form-control editor5']) !!}
                </p>
            </div>
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Valores2', 'Valores e Condições de
                    Pagamento:') !!}<span style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::textarea('Valores2', null, ['class' => 'form-control editor6']) !!}</p>
            </div>
            <div class="row">
                <p class="col-md-3 text-right col-sm-12">{!! Form::label('Matricula2', 'Valor da Matrícula:') !!}<span
                        style="color: red">*</span></p>
        ...
        <div class="tab-pane" id="tab_4">
            <div class="row">
                <p class="col-md-2 col-sm-12 text-right">{!! Form::label('Prestadora', 'Prestadora:') !!}<span
                        style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::textarea('Prestadora', null, ['class' => 'form-control editor7']) !!}
                </p>
            </div>
            <div class="row">
                <p class="col-md-2 col-sm-12 text-right">{!! Form::label('MultaContrato', 'Valor da Multa (contrato):')
                    !!}<span style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::number('MultaContrato', null, ['class' => 'form-control']) !!}
                </p>
            </div>
            <div class="row">
                <p class="col-md-2 col-sm-12 text-right">{!! Form::label('MoraContrato', 'Valor da Mora (contrato):')
                    !!}<span style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::number('MoraContrato', null, ['class' => 'form-control']) !!}
                </p>
            </div>
            <div class="row">
                <p class="col-md-2 col-sm-12 text-right">{!! Form::label('Multa', 'Valor da Multa:') !!}<span
                        style="color: red">*</span></p>
                <p class="col-md-8 col-sm-12">{!! Form::number('Multa', null, ['class' => 'form-control']) !!}</p>
            </div>
            <div class="row">
                <p class="col-md-2 col-sm-12 text-right">{!! Form::label('Mora', 'Valor da Mora:') !!}<span
                        style="color: red">*</span></p>
