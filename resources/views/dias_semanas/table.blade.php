        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class='btn-group'>
                        <a href="{!! route('diasSemanas.edit', [$diasSemana->id]) !!}" class='btn btn-default btn-md'><i
                                class="glyphicon glyphicon-edit"></i></a>
                        {!! Form::button('<i class="glyphicon glyphicon-trash"></i>', ['type' => 'submit', 'class' =>
                        'btn btn-danger btn-md', 'onclick' => "return confirm('Tem certeza que deseja deletar o dia de
                        aula selecionado?')"]) !!}
                    </div>
                    {!! Form::close() !!}
                </td>
