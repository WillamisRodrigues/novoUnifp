...
<div class="container formulario-padrao">
    ...
    <div class="row">
        ...
        <p class="col-sm-12 col-md-6">
            <label>{!! Form::radio('Tipo', 'Sangria', ['class' =>'form-control']) !!} <span class="input-radio-prioridade" style="color: black"> Sangria </span></label>
            <label>{!! Form::radio('Tipo', 'Receita', ['class' =>'form-control']) !!} <span class="input-radio-prioridade" style="color: black"> Receita </span></label>
        </p>
    </div>
    ...
    <div class="row">
        ...
        <p class="col-sm-12 col-md-6">{!! Form::text('FormaPgto', null, ['class' => 'form-control']) !!}</p>
    </div>
    ...
    <div class="row">
        ...
        <p class="col-sm-12 col-md-6">
            ...
            <label>{!! Form::radio('Status', 'FaltaPagar', ['class' =>
                'form-control']) !!} <span class="input-radio-prioridade" style=" background-color: #D73925"> Aguardando Pagamento </span>
            </label>
        </p>
    </div>
