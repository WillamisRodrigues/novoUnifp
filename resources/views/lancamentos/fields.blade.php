...
<div class="container formulario-padrao">
    ...
    <div class="row">
        ...
        <p class="col-sm-12 col-md-6">
            <label>{!! Form::radio('Tipo', 'Sangria', ['class' =>'form-control']) !!} <span
                    class="input-radio-prioridade" style="color: black"> Sangria </span></label>
            <label>{!! Form::radio('Tipo', 'Receita', ['class' =>'form-control']) !!} <span
                    class="input-radio-prioridade" style="color: black"> Receita </span></label>
        </p>
    </div>
    ...
    <!-- Lancamento Field -->
    <div class="row">
        <p class="col-sm-12 col-md-3">{!! Form::label('Lancamento', 'Data de Lançamento:') !!}</p>
        <div class="col-sm-12 col-md-6 input-group"
            style="padding-right: 15px; padding-left: 15px; margin-bottom: 10px;">
            {!! Form::date('Lancamento', null, ['class' => 'form-control', 'id' =>
            'Lancamento'])!!}
            <div class="input-group-addon">
                <i class="fa fa-calendar"></i>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 input-group"
            style="padding-right: 15px; padding-left: 15px; margin-bottom: 10px;">
            {!! Form::text('Valor', null, ['class' => 'form-control', 'id' =>
            'Valor'])!!}
            <div class="input-group-addon">
