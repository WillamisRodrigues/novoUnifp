...
!(function(a) {
	...
	var j = (function() {
		...
		k = function(b, c) {
			a.data(b, 'datepicker', this),
				...
				(this.component =
					!!this.element.hasClass('date') && this.element.find('.add-on, .input-group-addon, .btn')),
	...
	k.prototype = {
				...
				for (var u, v, w = []; p.valueOf() < t; ) {
					if (((u = p.getUTCDay()), u === this.o.weekStart && (w.push('<tr>'), this.o.calendarWeeks))) {
						var x = new Date(+p + ((this.o.weekStart - u - 7) % 7) * 864e5),
							...
							z = new Date(
								Number((z = c(y.getUTCFullYear(), 0, 1))) + ((11 - z.getUTCDay()) % 7) * 864e5
							),
							A = (y - z) / 864e5 / 7 + 1;
		...
		_toggle_multidate: function(a) {
			...
			if (
				(a || this.dates.clear(),
				b !== -1
					? (this.o.multidate === !0 || this.o.multidate > 1 || this.o.toggleActive) && this.dates.remove(b)
					: this.o.multidate === !1 ? (this.dates.clear(), this.dates.push(a)) : this.dates.push(a),
	...
	var q = (a.fn.datepicker.dates = {
		...
		r = {
			...
			parseDate: function(c, e, f, g) {
				function h(a, b) {
					return (
						b === !0 && (b = 10), a < 100 && ((a += 2e3), a > new Date().getFullYear() + b && (a -= 100)), a
					);
				}
				function i() {
	...
	(r.template =
		...
		a(document).on('focus.datepicker.data-api click.datepicker.data-api', '[data-provide="datepicker"]', function(
			b
		) {
			var c = a(this);
