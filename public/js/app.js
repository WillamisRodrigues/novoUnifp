			...
			function(e) {
				...
				function h(e) {
					...
					return r && 'BODY' !== r && 'HTML' !== r
						? -1 !== [ 'TH', 'TD', 'TABLE' ].indexOf(n.nodeName) && 'static' === u(n, 'position') ? h(n) : n
				...
				function g(e, t) {
					...
					if ((e !== u && t !== u) || r.contains(i))
						return 'BODY' === (s = (a = u).nodeName) || ('HTML' !== s && h(a.firstElementChild) !== a)
							? h(u)
							: u;
					var c = v(e);
				...
				function D(e, t, n, r) {
					...
					if ('viewport' === r)
						...
						var s = void 0;
						'scrollParent' === r
							? 'BODY' === (s = l(c(t))).nodeName && (s = e.ownerDocument.documentElement)
						...
						modifiers: {
									...
									var c = t.priority,
										...
										f = {
											primary: function(e) {
												var n = l[e];
												return (
													l[e] < u[e] && !t.escapeWithReference && (n = Math.max(l[e], u[e])),
													E({}, e, n)
												);
											},
							...
							arrow: {
								...
								fn: function(e, t) {
									...
									return (
										(b = Math.max(Math.min(a[l] - v, b), 0)),
										(e.arrowElement = r),
										(e.offsets.arrow = (E((n = {}), p, Math.round(b)), E(n, d, ''), n)),
										e
									);
								},
								element: '[x-arrow]'
							...
							computeStyle: {
								...
								fn: function(e, t) {
									...
									if (
										...
										(v =
											'right' === p
												? 'HTML' === s.nodeName ? -s.clientWidth + l.right : -u.width + l.right
												: l.left),
										a && d)
									)
	...
	function(e, t, n) {
		...
		!(function(t, n) {
			...
			function T(e) {
				return null == e
					? e + ''
					: 'object' == typeof e || 'function' == typeof e ? p[d.call(e)] || 'object' : typeof e;
			}
			var E = function(e, t) {
			...
			(E.fn = E.prototype = {
				...
				E.extend({
					...
					makeArray: function(e, t) {
						var n = t || [];
						return (
							null != e && (C(Object(e)) ? E.merge(n, 'string' == typeof e ? [ e ] : e) : l.call(n, e)), n
						);
					},
				...
				E.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), function(
					e,
					t
				) {
					...
					(u = oe.select = function(e, t, n, i) {
						...
						if (((n = n || []), 1 === d.length)) {
							...
							for (
								...
								if (
									(f = r.find[l]) &&
									(i = f(c.matches[0].replace(Z, ee), (J.test(u[0].type) && ve(t.parentNode)) || t))
								) {
			...
			((E.fn.init = function(e, t, n) {
				...
				if (((n = n || L), 'string' == typeof e)) {
					if (
						!(r =
							'<' === e[0] && '>' === e[e.length - 1] && e.length >= 3 ? [ null, e, null ] : j.exec(e)) ||
						(!r[1] && t)
					)
				...
				return e.nodeType
					...
					: y(e) ? (void 0 !== n.ready ? n.ready(e) : e(E)) : E.makeArray(e, this);
			}).prototype =
				E.fn),
				(L = E(a));
			...
			E.fn.extend({
				...
				index: function(e) {
					return e
						? 'string' == typeof e ? f.call(E(e), this[0]) : f.call(this, e.jquery ? e[0] : e)
				...
				E.each(
					{
						...
						contents: function(e) {
							return I(e, 'iframe')
								? e.contentDocument
								: (I(e, 'template') && (e = e.content || e), E.merge([], e.childNodes));
						}
					},
					function(e, t) {
						E.fn[e] = function(n, r) {
			...
			function W(e, t, n, r) {
				...
				try {
					e && y((i = e.promise))
						...
						: e && y((i = e.then)) ? i.call(e, t, n) : t.apply(void 0, [ e ].slice(r));
				} catch (e) {
					n.apply(void 0, [ e ]);
				}
			}
			(E.Callbacks = function(e) {
				...
				E.extend({
					...
					when: function(e) {
						...
						if (
							t <= 1 &&
							(W(e, o.done(a(n)).resolve, o.reject, !t), 'pending' === o.state() || y(i[n] && i[n].then))
						)
							return o.then();
				...
				E.extend({
					...
					ready: function(e) {
						(!0 === e ? --E.readyWait : E.isReady) ||
							((E.isReady = !0), (!0 !== e && --E.readyWait > 0) || B.resolveWith(a, [ E ]));
					}
				}),
				(E.ready.then = B.then),
			...
			(Y.uid = 1),
				(Y.prototype = {
					...
					remove: function(e, t) {
						...
						if (void 0 !== r) {
							if (void 0 !== t) {
								n = (t = Array.isArray(t) ? t.map(X) : (t = X(t)) in r ? [ t ] : t.match(H) || [])
									.length;
								for (; n--; ) delete r[t[n]];
							}
			...
			var re = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
				...
				ae = function(e, t) {
					return (
						...
						('' === e.style.display && E.contains(e.ownerDocument, e) && 'none' === E.css(e, 'display'))
					);
				},
				se = function(e, t, n, r) {
					var i,
			...
			function ue(e, t, n, r) {
				...
				if (l && l[3] !== c) {
					for (u /= 2, c = c || l[3], l = +u || 1; a--; )
						E.style(e, t, l + c), (1 - o) * (1 - (o = s() / u || 0.5)) <= 0 && (a = 0), (l /= o);
			...
			function we(e, t, n, r, i) {
				...
				for (f.textContent = '', d = 0; (o = p[d++]); )
					if (r && E.inArray(o, r) > -1) i && i.push(o);
						...
						((c = E.contains(o.ownerDocument, o)), (a = ge(f.appendChild(o), 'script')), c && me(a), n)
					)
						...
						for (a = E.event.handlers.call(this, s, c), t = 0; (i = a[t++]) && !s.isPropagationStopped(); )
							for (
								...
								(s.rnamespace && !s.rnamespace.test(o.namespace)) ||
									...
									(s.data = o.data),
									void 0 !==
										(r = ((E.event.special[o.origType] || {}).handle || o.handler)
											.apply(i.elem, u)) &&
										!1 === (s.result = r) &&
					...
					e && e.type
						? ((this.originalEvent = e),
							...
							(this.isDefaultPrevented =
								e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? Ae : Se),
			...
			function je(e, t) {
				return (
					(I(e, 'table') && I(11 !== t.nodeType ? t : t.firstChild, 'tr') && E(e).children('tbody')[0]) || e
				);
			}
			function Pe(e) {
				...
				if (
					...
					for (s = (a = E.map(ge(i, 'script'), Pe)).length; f < p; f++)
						(u = i),
							...
							n.call(e[f], u, f);
					if (s)
						for (l = a[a.length - 1].ownerDocument, E.map(a, Re), f = 0; f < s; f++)
							(u = a[f]),
								he.test(u.type || '') &&
			...
			function Me(e, t, n) {
				for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
					n || 1 !== r.nodeType || E.cleanData(ge(r)),
						r.parentNode &&
							(n && E.contains(r.ownerDocument, r) && me(ge(r, 'script')), r.parentNode.removeChild(r));
				return e;
			}
			E.extend({
				...
				clone: function(e, t, n) {
					...
					if (!(m.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || E.isXMLDoc(e)))
						for (a = ge(l), r = 0, i = (o = ge(e)).length; r < i; r++)
							(s = o[r]),
								(u = a[r]),
								(c = void 0),
					...
					if (t)
						if (n) for (o = o || ge(e), a = a || ge(l), r = 0, i = o.length; r < i; r++) $e(o[r], a[r]);
						else $e(e, l);
			...
			function Ze(e, t, n, r, i, o) {
				...
				for (; a < 4; a += 2)
					'margin' === n && (u += E.css(e, n + oe[a], !0, i)),
						r
							? ('content' === n && (u -= E.css(e, 'padding' + oe[a], !0, i)),
								'margin' !== n && (u -= E.css(e, 'border' + oe[a] + 'Width', !0, i)))
							: ((u += E.css(e, 'padding' + oe[a], !0, i)),
								'padding' !== n
									? (u += E.css(e, 'border' + oe[a] + 'Width', !0, i))
									: (s += E.css(e, 'border' + oe[a] + 'Width', !0, i)));
				return (
					!r &&
						o >= 0 &&
			...
			function et(e, t, n) {
				...
				return (
					...
					('auto' === i || (!parseFloat(i) && 'inline' === E.css(e, 'display', !1, r))) &&
				...
				style: function(e, t, n, r) {
					if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
						var i,
							...
							u = ze.test(t),
							c = e.style;
						if ((u || (t = Ye(s)), (a = E.cssHooks[t] || E.cssHooks[s]), void 0 === n))
							return a && 'get' in a && void 0 !== (i = a.get(e, !1, r)) ? i : c[t];
						'string' === (o = typeof n) && (i = ie.exec(n)) && i[1] && ((n = ue(e, t, i)), (o = 'number')),
							null != n &&
								n == n &&
								('number' === o && (n += (i && i[3]) || (E.cssNumber[s] ? '' : 'px')),
					...
					_default: {
						get: function(e) {
							...
							return 1 !== e.elem.nodeType || (null != e.elem[e.prop] && null == e.elem.style[e.prop])
								? e.elem[e.prop]
								: (t = E.css(e.elem, e.prop, '')) && 'auto' !== t ? t : 0;
						},
						set: function(e) {
							E.fx.step[e.prop]
								? E.fx.step[e.prop](e)
			...
			function lt(e, t, n) {
				...
				for (
					...
					if ((r = lt.prefilters[o].call(c, e, l, c.opts)))
						return y(r.stop) && (E._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)), r;
				return (
					E.map(l, ct, c),
					...
					attr: function(e, t, n) {
						...
						if (3 !== o && 8 !== o && 2 !== o)
							return void 0 === e.getAttribute
								? E.prop(e, t, n)
								: ((1 === o && E.isXMLDoc(e)) ||
										(i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? ft : void 0)),
									void 0 !== n
										? null === n
										...
										: i && 'get' in i && null !== (r = i.get(e, t))
											? r
											: null == (r = E.find.attr(e, t)) ? void 0 : r);
					},
					attrHooks: {
						type: {
							set: function(e, t) {
					...
					propHooks: {
						tabIndex: {
							get: function(e) {
								...
								return t
									? parseInt(t, 10)
									: dt.test(e.nodeName) || (ht.test(e.nodeName) && e.href) ? 0 : -1;
							}
						}
					},
					...
					return arguments.length
						...
						: i
							? (t = E.valHooks[i.type] || E.valHooks[i.nodeName.toLowerCase()]) &&
								...
								? n
								: 'string' == typeof (n = i.value) ? n.replace(yt, '') : null == n ? '' : n
							: void 0;
				}
			}),
				E.extend({
			...
			function Ot(e, t, n, r) {
				...
				if (Array.isArray(t))
					E.each(t, function(t, i) {
						n || xt.test(e)
							? r(e, i)
							: Ot(e + '[' + ('object' == typeof i && null != i ? t : '') + ']', i, n, r);
					});
					...
					ajax: function(e, t) {
						...
						h.hasContent
							...
							: ((d = h.url.slice(i.length)),
								...
								!1 === h.cache &&
									((i = i.replace(kt, '$1')), (d = (Et.test(i) ? '&' : '?') + '_=' + Tt++ + d)),
								(h.url = i + d)),
						h.ifModified &&
							(E.lastModified[i] && x.setRequestHeader('If-Modified-Since', E.lastModified[i]),
						...
						function C(e, t, a, s) {
							...
							l ||
								...
								c
									? (h.ifModified &&
											((w = x.getResponseHeader('Last-Modified')) && (E.lastModified[i] = w),
								...
								y.fireWith(v, [ x, T ]),
								f && (g.trigger('ajaxComplete', [ x, h ]), --E.active || E.event.trigger('ajaxStop')));
						}
						return x;
					},
				...
				E.each([ 'get', 'post' ], function(e, t) {
					E[t] = function(e, n, r, i) {
						return (
							...
							E.ajax(
								E.extend({ url: e, type: t, dataType: i, data: n, success: r }, E.isPlainObject(e) && e)
							)
						);
					};
				}),
			...
			(m.cors = !!Bt && 'withCredentials' in Bt),
				...
				E.ajaxTransport('script', function(e) {
					...
					if (e.crossDomain)
						return {
							send: function(r, i) {
								(t = E('<script>').prop({ charset: e.scriptCharset, src: e.url }).on(
									'load error',
									(n = function(e) {
			...
			E.ajaxSetup({
					...
					if (s || 'jsonp' === e.dataTypes[0])
						return (
							...
							s
								...
								: !1 !== e.jsonp && (e.url += (Et.test(e.url) ? '&' : '?') + e.jsonp + '=' + i),
				...
				(m.createHTMLDocument = (((Ut = a.implementation.createHTMLDocument('').body).innerHTML =
					'<form></form><form></form>'),
				...
				(E.parseHTML = function(e, t, n) {
					return 'string' != typeof e
						...
						: ('boolean' == typeof t && ((n = t), (t = !1)),
							...
							(i = k.exec(e))
								? [ t.createElement(i[1]) ]
								: ((i = we([ e ], t, o)), o && o.length && E(o).remove(), E.merge([], i.childNodes)));
					var r, i, o;
				}),
				...
				E.each([ 'ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend' ], function(
					e,
					t
				) {
					E.fn[t] = function(e) {
								...
								function(t, n, i) {
									...
									return _(t)
										...
										: 9 === t.nodeType
											...
											: void 0 === i ? E.css(t, n, s) : E.style(t, n, i, s);
								},
								t,
								a ? i : void 0,
								a
		...
		(function(e, r) {
			...
			(function() {
				var o,
					...
					wt = RegExp(
						[
							ft + '?' + ot + "+(?:['’](?:d|ll|m|re|s|t|ve))?(?=" + [ tt, ft, '$' ].join('|') + ')',
							dt + "+(?:['’](?:D|LL|M|RE|S|T|VE))?(?=" + [ tt, ft + pt, '$' ].join('|') + ')',
				...
				(At[le] = At[fe] = At[pe] = At[de] = At[he] = At[ve] = At[ge] = At[me] = At[ye] = !0),
					(At[W] = At[q] = At[ue] = At[U] = At[ce] = At[V] = At[K] = At[G] = At[Q] = At[Y] = At[Z] = At[
						te
					] = At[ne] = At[re] = At[ae] = !1);
				var St = {};
				(St[W] = St[q] = St[ue] = St[ce] = St[U] = St[V] = St[le] = St[fe] = St[pe] = St[de] = St[he] = St[
					Q
				] = St[Y] = St[Z] = St[te] = St[ne] = St[re] = St[ie] = St[ve] = St[ge] = St[me] = St[ye] = !0),
					(St[K] = St[G] = St[ae] = !1);
				var Ot = { '\\': '\\', "'": "'", '\n': 'n', '\r': 'r', '\u2028': 'u2028', '\u2029': 'u2029' },
					Dt = parseFloat,
					It = parseInt,
				...
				var jn = (function e(t) {
							...
							if (v == Z || v == W || (g && !i)) {
								...
								s = (function(e, t, n) {
									...
									switch (t) {
										...
										case te:
											return (
												((o = new (i = e).constructor(i.source, Be.exec(i))).lastIndex =
													i.lastIndex),
												o
											);
										case ne:
					...
					(dr.templateSettings = {
						...
						(br.prototype.clear = function() {
							(this.size = 0),
								(this.__data__ = { hash: new yr(), map: new (Jn || _r)(), string: new yr() });
						}),
					...
					function ni(e, t, n) {
						for (
							var i = n ? Jt : Yt, a = e[0].length, s = e.length, u = s, c = r(s), l = 1 / 0, f = [];
							u--;
					...
					function ui(e) {
						return 'function' == typeof e
							? e
							: null == e ? Iu : 'object' == typeof e ? (ms(e) ? hi(e[0], e[1]) : di(e)) : Mu(e);
					}
					function ci(e) {
						if (!Yo(e)) return Un(e);
						var t = [];
					...
					function Li(e, t, n, r) {
						t = n(t);
						for (
							var i = 0, a = null == e ? 0 : e.length, s = t != t, u = null === t, c = Ps(t), l = t === o;
							i < a;
						...
						return Io(function(t) {
							...
							for (r = s ? r : n; ++r < n; ) {
								var c = jo((a = t[r])),
									l = 'wrapper' == c ? Lo(a) : o;
								s =
									l && Xo(l[0]) && l[1] == (x | b | T | C) && !l[4].length && 1 == l[9]
										? s[jo(l[0])].apply(s, l[3])
										: 1 == a.length && Xo(a) ? s[c]() : s.thru(a);
							}
							return function() {
								var e = arguments,
									r = e[0];
					...
					function bo(e) {
						return function(t, n) {
							return (
								('string' == typeof t && 'string' == typeof n) || ((t = Bs(t)), (n = Bs(n))), e(t, n)
							);
						};
					}
						...
						if (
							(g &&
								(function(e, t) {
									...
									(s = t[5]) &&
										((u = e[5]), (e[5] = u ? to(u, s, t[6]) : s), (e[6] = u ? On(e[5], f) : t[6])),
										(s = t[7]) && (e[7] = s),
							...
							(i = A[3]),
							(a = A[4]),
							!(l = A[9] = A[9] === o ? (p ? 0 : e.length) : Vn(A[9] - d, 0)) &&
								t & (b | w) &&
								(t &= ~(b | w)),
							t && t != m)
						)
								...
								t == b || t == w
									? (function(e, t, n) {
											...
											return function a() {
												...
												return (s -= f.length) < n
													? wo(e, t, ho, a.placeholder, o, u, f, o, o, n - s)
													: Vt(this && this !== Lt && this instanceof a ? i : e, this, u);
											};
										})(e, t, l)
									: (t != T && t != (m | T)) || a.length
										? ho.apply(o, A)
												...
												return function t() {
													for (
														var s = -1,
															...
															l = i.length,
															f = r(l + u),
															p = this && this !== Lt && this instanceof t ? a : e;
														++c < l;
							...
							var S = (function(e, t, n) {
								var r = t & m,
									i = lo(e);
								return function t() {
									return (this && this !== Lt && this instanceof t ? i : e).apply(
										r ? n : this,
										arguments
									);
								};
					...
					function Bo(e, t, n) {
						...
						return o || ++r != i
							? o
							: !!(i = null == e ? 0 : e.length) && As(i) && zo(a, i) && (ms(e) || gs(e));
					}
					function Uo(e) {
					...
					function Go(e, t) {
						...
						var n = typeof e;
						return (
							!('number' != n && 'symbol' != n && 'boolean' != n && null != e && !Ps(e)) ||
							Ie.test(e) ||
							!De.test(e) ||
							(null != t && e in tt(t))
						);
					...
					((Yn && qo(new Yn(new ArrayBuffer(1))) != ce) ||
						(Jn && qo(new Jn()) != Q) ||
					...
					function ma(e, t, n) {
						...
						var i = r - 1;
						return (
							n !== o && ((i = Ws(n)), (i = n < 0 ? Vn(r + i, 0) : zn(i, r - 1))), sn(e, Ro(t, 3), i, !0)
						);
					}
					function ya(e) {
					...
					var Wa = Io(function(e) {
						...
						return !(t > 1 || this.__actions__.length) && r instanceof mr && zo(n)
					...
					var Ja = Ei(function(e, t) {
							...
							var n = t.length;
							return (
								n > 1 && Ko(e, t[0], t[1]) ? (t = []) : n > 2 && Ko(t[0], t[1], t[2]) && (t = [ t[0] ]),
								mi(e, Ur(t, 1), [])
							);
						}),
						Za =
					...
					var cs = Ki(function(e, t) {
							var n = (t = 1 == t.length && ms(t[0]) ? Zt(t[0], mn(Ro())) : Zt(Ur(t, 1), mn(Ro())))
								.length;
					...
					function Es(e) {
						...
						var t = Jr(e);
						return (
							t == K || t == z || ('string' == typeof e.message && 'string' == typeof e.name && !ks(e))
						);
					}
					function xs(e) {
						if (!Ss(e)) return !1;
					...
					function Fs(e) {
						return e
							? (e = Bs(e)) === L || e === -L ? (e < 0 ? -1 : 1) * P : e == e ? e : 0
							: 0 === e ? e : 0;
					}
					function Ws(e) {
						var t = Fs(e),
					...
					return (
						...
						(dr.throttle = function(e, t, n) {
							...
							return (
								...
								is(e, t, { leading: r, maxWait: t, trailing: i })
							);
						}),
						(dr.thru = Fa),
						(dr.toArray = Ms),
						...
						(dr.lastIndexOf = function(e, t, n) {
							...
							var i = r;
							return (
								n !== o && (i = (i = Ws(n)) < 0 ? Vn(r + i, 0) : zn(i, r - 1)),
								t == t
									? (function(e, t, n) {
						...
						(dr.template = function(e, t, n) {
							...
							var i,
								...
								h =
									'//# sourceURL=' +
									('sourceURL' in t ? t.sourceURL : 'lodash.templateSources[' + ++Ct + ']') +
									'\n';
							...
							if ((s && (u += c.length - u), Ns(i))) {
								if (e.slice(u).search(i)) {
									var l,
										f = c;
									for (
										i.global || (i = nt(i.source, Vs(Be.exec(i)) + 'g')), i.lastIndex = 0;
										(l = i.exec(f));
						...
						Kt([ 'drop', 'take' ], function(e, t) {
							(mr.prototype[e] = function(n) {
								...
								return (
									r.__filtered__
										? (r.__takeCount__ = zn(n, r.__takeCount__))
										: r.__views__.push({
												size: zn(n, $),
						...
						Kr(mr.prototype, function(e, t) {
							...
							i &&
								(dr.prototype[t] = function() {
									...
									return h && v
										? e.apply(this, s)
										: ((g = this.thru(f)), h ? (r ? g.value()[0] : g.value()) : g);
								});
						}),
						...
						(dr.prototype.reverse = function() {
							...
							if (e instanceof mr) {
								...
								return (
									...
									(t = t.reverse()).__actions__.push({ func: Fa, args: [ Sa ], thisArg: o }),
		...
		!(function(e, t, n) {
			...
			var s = (function(e) {
								...
								if (Object.prototype.hasOwnProperty.call(n, i)) {
									var o = n[i],
										...
										s =
											a && r.isElement(a)
												? 'element'
												: ((u = a), {}.toString.call(u).match(/\s([a-z]+)/i)[1].toLowerCase());
				...
				u = (function(e) {
					...
					return (
						e(document).on(n.CLICK_DATA_API, '[data-dismiss="alert"]', o._handleDismiss(new o())),
				...
				c = (function(e) {
					...
					return (
						e(document)
							.on(a.CLICK_DATA_API, o.DATA_TOGGLE_CARROT, function(t) {
								t.preventDefault();
								var n = t.target;
				...
				l = (function(e) {
						...
						h = (function() {
							...
							return (
								...
								(h._slide = function(t, n) {
									...
									if (
										(t === l.NEXT
											? ((r = p.LEFT), (i = p.NEXT), (o = l.LEFT))
											: ((r = p.RIGHT), (i = p.PREV), (o = l.RIGHT)),
								...
								(o._jQueryInterface = function(t) {
									return this.each(function() {
										...
										if ((r || ((r = new o(this, i)), e(this).data(n, r)), 'number' == typeof t))
											r.to(t);
					...
					return (
						...
						e(window).on(f.LOAD_DATA_API, function() {
							for (
								var t = [].slice.call(document.querySelectorAll(d.DATA_RIDE)), n = 0, r = t.length;
								n < r;
								n++
							) {
								var i = e(t[n]);
					...
					var t = 'collapse',
						...
						d = (function() {
							function r(t, n) {
								...
								for (
									var r = [].slice.call(document.querySelectorAll(p.DATA_TOGGLE)),
										i = 0,
										o = r.length;
									i < o;
									i++
							...
							return (
								...
								(d.show = function() {
									...
									if (
										!(
											...
											e(this._element).hasClass(l.SHOW) ||
											(this._parent &&
												0 ===
													(t = [].slice
										...
										if ((e(this._element).trigger(a), !a.isDefaultPrevented())) {
											t &&
												(r._jQueryInterface.call(e(t).not(this._selector), 'hide'),
												i || e(t).data(n, null));
									...
									if (!this._isTransitioning && e(this._element).hasClass(l.SHOW)) {
										...
										if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
											...
											(this._element.style[r] = this._element.getBoundingClientRect()[r] + 'px'),
												...
												e(this._element)
													.addClass(l.COLLAPSING)
													.removeClass(l.COLLAPSE)
													.removeClass(l.SHOW);
											...
											if (i > 0)
												for (var o = 0; o < i; o++) {
													...
													if (null !== u) {
														...
														f.hasClass(l.SHOW) ||
															e(a).addClass(l.COLLAPSED).attr('aria-expanded', !1);
													}
												}
								...
								(d._getConfig = function(e) {
									return (
										((e = a({}, o, e)).toggle = Boolean(e.toggle)), s.typeCheckConfig(t, e, u), e
									);
								}),
								...
								(r._jQueryInterface = function(t) {
									return this.each(function() {
										...
										if (
											(!s && u.toggle && /show|hide/.test(t) && (u.toggle = !1),
											s || ((s = new r(this, u)), i.data(n, s)),
											'string' == typeof t)
										) {
				...
				p = (function(e) {
						...
						g = (function() {
							...
							return (
									...
									if (!this._element.disabled && !e(this._element).hasClass(f.DISABLED)) {
										...
										if ((u._clearMenus(), !r)) {
											...
											if ((e(t).trigger(o), !o.isDefaultPrevented())) {
												...
												'ontouchstart' in document.documentElement &&
													0 === e(t).closest(p.NAVBAR_NAV).length &&
								...
								(g._getPlacement = function() {
									...
									return (
										t.hasClass(f.DROPUP)
											? ((n = d.TOP), e(this._menu).hasClass(f.MENURIGHT) && (n = d.TOPEND))
											: t.hasClass(f.DROPRIGHT)
												? (n = d.RIGHT)
												: t.hasClass(f.DROPLEFT)
													? (n = d.LEFT)
													: e(this._menu).hasClass(f.MENURIGHT) && (n = d.BOTTOMEND),
										n
									);
								}),
								...
								(g._getPopperConfig = function() {
									...
									'function' == typeof this._config.offset
										? (t.fn = function(t) {
												return (
													(t.offsets = a({}, t.offsets, e._config.offset(t.offsets) || {})), t
												);
											})
								...
								(u._clearMenus = function(t) {
									if (!t || (3 !== t.which && ('keyup' !== t.type || 9 === t.which)))
										for (
											var n = [].slice.call(document.querySelectorAll(p.DATA_TOGGLE)),
												i = 0,
												o = n.length;
											i < o;
											i++
											...
											? !(
													...
													(27 !== t.which &&
														((40 !== t.which && 38 !== t.which) ||
															e(t.target).closest(p.MENU).length))
												)
											: c.test(t.which)) &&
										(t.preventDefault(),
										t.stopPropagation(),
					...
					return (
						e(document)
							.on(l.KEYDOWN_DATA_API, p.DATA_TOGGLE, g._dataApiKeydownHandler)
							.on(l.KEYDOWN_DATA_API, p.MENU, g._dataApiKeydownHandler)
							.on(l.CLICK_DATA_API + ' ' + l.KEYUP_DATA_API, g._clearMenus)
							.on(l.CLICK_DATA_API, p.DATA_TOGGLE, function(t) {
							...
							return (
								...
								(r._jQueryInterface = function(t, n) {
									return this.each(function() {
										...
										if (
											(i || ((i = new r(this, s)), e(this).data('bs.modal', i)),
											'string' == typeof t)
										) {
							...
							return (
								...
								(m.setElementContent = function(t, n) {
									...
									'object' == typeof n && (n.nodeType || n.jquery)
										? r ? e(n).parent().is(t) || t.empty().append(n) : t.text(e(n).text())
										: t[r ? 'html' : 'text'](n);
								}),
								(m.getTitle = function() {
								...
								(o._jQueryInterface = function(t) {
									return this.each(function() {
										...
										if (
											...
											(n || ((n = new o(this, r)), e(this).data('bs.tooltip', n)),
											'string' == typeof t)
										) {
											if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
											n[t]();
								...
								(d._jQueryInterface = function(t) {
									return this.each(function() {
										...
										if (
											...
											(n || ((n = new d(this, r)), e(this).data('bs.popover', n)),
											'string' == typeof t)
										) {
											if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
											n[t]();
				...
				g = (function(e) {
							...
							return (
								...
								(p._activate = function(t) {
									...
									r.hasClass(c.DROPDOWN_ITEM)
										? (r.closest(l.DROPDOWN).find(l.DROPDOWN_TOGGLE).addClass(c.ACTIVE),
											r.addClass(c.ACTIVE))
										: (r.addClass(c.ACTIVE),
											r
								...
								(n._jQueryInterface = function(t) {
									return this.each(function() {
										var r = e(this).data('bs.scrollspy'),
											i = 'object' == typeof t && t;
										if (
											(r || ((r = new n(this, i)), e(this).data('bs.scrollspy', r)),
											'string' == typeof t)
										) {
					...
					return (
						e(window).on(u.LOAD_DATA_API, function() {
							for (
								var t = [].slice.call(document.querySelectorAll(l.DATA_SPY)), n = t.length, r = n;
								r--;
	...
	function(e, t, n) {
		...
		(s.prototype.request = function(e) {
			'string' == typeof e && (e = i.merge({ url: arguments[0] }, arguments[1])),
				((e = i.merge(r, { method: 'get' }, this.defaults, e)).method = e.method.toLowerCase());
			var t = [ a, void 0 ],
				n = Promise.resolve(e);
			for (
	...
	function(e, t, n) {
		...
		(function(t, n) {
			...
			var ne = function() {
					return (
						void 0 === B &&
							(B = !V && !z && void 0 !== t && (t.process && 'server' === t.process.env.VUE_ENV)),
						B
					);
				},
					...
					Object.defineProperty(e, t, {
						...
						set: function(t) {
							...
							t === r ||
								(t != t && r != r) ||
								(s && !u) ||
								(u ? u.call(e, t) : (n = t), (c = !i && xe(t)), o.notify());
						}
					});
				}
			}
				...
				if (
					...
					(function(e, t) {
						...
						if (n) {
							...
							else if (l(n)) for (var a in n) (i = n[a]), (o[E(a)] = l(i) ? i : { type: i });
							e.props = o;
						}
					})(t),
					(function(e, t) {
			...
			if (void 0 !== n && ie(n))
				...
				(!ie(MessageChannel) && '[object MessageChannelConstructor]' !== MessageChannel.toString())
			)
				Ue = function() {
					setTimeout(Ke, 0);
				};
									...
									i((c = t[u])) ||
										...
										Array.isArray(c)
											? c.length > 0 &&
												(ut((c = e(c, (n || '') + '_' + u))[0]) &&
													ut(f) &&
													((r[l] = ge(f.text + c[0].text)), c.shift()),
												r.push.apply(r, c))
											: s(c)
												? ut(f) ? (r[l] = ge(f.text + c)) : '' !== c && r.push(ge(c))
												: ut(c) && ut(f)
													? (r[l] = ge(f.text + c.text))
													: (a(t._isVList) &&
															o(c.tag) &&
															i(c.key) &&
															o(n) &&
			...
			function ct(e, t) {
				return (
					(e.__esModule || (ae && 'Module' === e[Symbol.toStringTag])) && (e = e.default),
					u(e) ? t.extend(e) : e
				);
			}
			function lt(e) {
			...
			function $t(e, t, n) {
				var r = !ne();
				'function' == typeof n
					? ((Lt.get = r ? Ht(t) : Mt(n)), (Lt.set = k))
					: ((Lt.get = n.get ? (r && !1 !== n.cache ? Ht(t) : Mt(n.get)) : k), (Lt.set = n.set || k)),
				...
				if (!i(e)) {
					...
					if ((u(e) && (e = l.extend(e)), 'function' == typeof e)) {
						...
						return new de(
							...
							void 0,
							n,
							{ Ctor: e, propsData: p, listeners: d, tag: c, children: s },
							f
						);
					}
				}
					...
					(function(e, t, n, r, s) {
						...
						if ('string' == typeof t) {
							...
							(l = (e.$vnode && e.$vnode.ns) || F.getTagNamespace(t)),
								(c = F.isReservedTag(t)
									? new de(F.parsePlatformTagName(t), n, r, void 0, void 0, e)
			...
			function mn(e, t) {
				return Array.isArray(e)
					? e.indexOf(t) > -1
					: 'string' == typeof e ? e.split(',').indexOf(t) > -1 : !!f(e) && e.test(t);
			}
			function yn(e, t) {
				var n = e.cache,
					r = e.keys,
				...
				e.prototype._init = function(e) {
					...
					(t._uid = fn++),
						...
						e && e._isComponent
							...
							: (t.$options = je(pn(t.constructor), e || {}, t)),
						(t._renderProxy = t),
						(t._self = t),
						(function(e) {
							var t = e.$options,
					...
					KeepAlive: {
						...
						render: function() {
							...
							if (n) {
								...
								a[u]
									? ((t.componentInstance = a[u].componentInstance), y(s, u), s.push(u))
									: ((a[u] = t),
										s.push(u),
			...
			!(function(e) {
				...
				Object.defineProperty(e, 'config', t),
					(e.util = { warn: se, extend: D, mergeOptions: je, defineReactive: Ce }),
					(e.set = Ae),
					(e.delete = Se),
					(e.nextTick = Je),
				...
				Object.defineProperty(hn.prototype, '$isServer', { get: ne }),
			...
			function Vn(e, t) {
				...
				if (o(n)) {
					var r = e.context,
						...
						a = r.$refs;
					t
						? Array.isArray(a[n]) ? y(a[n], i) : a[n] === i && (a[n] = void 0)
						: e.data.refInFor
							? Array.isArray(a[n]) ? a[n].indexOf(i) < 0 && a[n].push(i) : (a[n] = [ i ])
							: (a[n] = i);
				}
			}
			var zn = new de('', {}, []),
						...
						for (n in u)
							(r = s[n]),
								...
								r
									...
									: (tr(i, 'bind', t, e), i.def && i.def.inserted && c.push(i));
						if (c.length) {
							var f = function() {
				...
				e.tagName.indexOf('-') > -1
					...
					: An(t)
						...
						: Cn(t)
							...
							: On(t) ? (In(n) ? e.removeAttributeNS(Sn, Dn(t)) : e.setAttributeNS(Sn, t, n)) : or(e, t, n);
			}
			function or(e, t, n) {
			...
			function Hr(e, t, n, r) {
				...
				(t =
					...
					jr.addEventListener(e, t, ee ? { capture: n, passive: r } : n);
			}
			function Mr(e, t, n, r) {
			...
			var Gr,
				...
				Jr = [ 'Webkit', 'Moz', 'ms' ],
				Zr = w(function(e) {
					if (((Gr = Gr || document.createElement('div').style), 'filter' !== (e = E(e)) && e in Gr))
						return e;
				...
				return (
					t === ui
						...
						: t === ci
							...
							: (f = (n = (l = Math.max(a, c)) > 0 ? (a > c ? ui : ci) : null)
									? n === ui ? o.length : u.length
									: 0),
					{ type: n, timeout: l, propCount: f, hasTransform: n === ui && _i.test(r[li + 'Property']) }
				);
			}
			function wi(e, t) {
				...
				function f(e, t, n, i, s, u, l) {
					if (
						...
						var f = e.data,
							...
							g = e.tag;
						o(g)
							? ((e.elm = e.ns ? c.createElementNS(e.ns, g) : c.createElement(g, e)),
								y(e),
								h(e, v, t),
								o(f) && m(e, t),
								d(n, e.elm, i))
											...
											for (
												...
												i(v)
													...
													: i(g)
														? (g = t[--h])
														: Gn(v, y)
															? (x(v, y, r, n, d), (v = t[++p]), (y = n[++d]))
															: Gn(g, b)
																? (x(g, b, r, n, m), (g = t[--h]), (b = n[--m]))
																: Gn(v, b)
																	? (x(v, b, r, n, m),
																	...
																	: Gn(g, y)
																		...
																		: (i(s) && (s = Xn(t, p, h)),
																			...
																			(y = n[++d]));
											p > h
												? _(e, i(n[m + 1]) ? null : n[m + 1].elm, n, d, m, r)
												: d > m && w(0, t, p, h);
										})(p, v, m, n, l)
									: o(m)
										? (o(e.text) && c.setTextContent(p, ''), _(p, null, m, 0, m.length - 1, n))
										: o(v) ? w(0, v, 0, v.length - 1) : o(e.text) && c.setTextContent(p, '')
					...
					if (!i(t)) {
						...
						if (i(e)) (l = !0), f(t, p);
							...
							if (!d && Gn(e, t)) x(e, t, p, null, null, s);
								...
								if (d) {
									if (
										(1 === e.nodeType && e.hasAttribute($) && (e.removeAttribute($), (n = !0)),
										a(n) && S(e, t, p))
									)
										return C(t, p, !0), e;
				...
				inserted: function(e, t, n, r) {
					'select' === n.tag
						? (r.elm && !r.elm._vOptions
								...
								: Ii(e, t, n.context),
							(e._vOptions = [].map.call(e.options, Li)))
						...
						if (n && (n = n.filter(Bi)).length) {
							...
							o.key =
								null == o.key
									...
									: s(o.key) ? (0 === String(o.key).indexOf(a) ? o.key : a + o.key) : o.key;
							var u = ((o.data || (o.data = {})).transition = Wi(this)),
								c = this._vnode,
								l = Fi(c);
							if (
								(o.data.directives && o.data.directives.some(Ui) && (o.data.show = !0),
								l &&
									l.data &&
									!(function(e, t) {
										...
										n.addEventListener(
											...
											(n._moveCb = function e(r) {
												(r && r.target !== n) ||
													...
													(n.removeEventListener(fi, e), (n._moveCb = null), mi(n, t));
											})
										);
								}
							}));
			...
			var Co,
				...
				Wo = w(ro);
			function qo(e, t, n) {
				return { type: 1, tag: e, attrsList: t, attrsMap: Go(t), parent: n, children: [] };
			}
			function Bo(e, t) {
				(Co = t.warn || yr),
					(Io = t.isPreTag || N),
					...
					(function(e, t) {
						...
						start: function(e, o, c) {
							...
							if (
								...
								n
									? i.length ||
										(n.if && (p.elseif || p.else) && (h(), zo(n, { exp: p.elseif, block: p })))
									: ((n = p), h()),
								r && !p.forbidden)
							)
								if (p.elseif || p.else)
						...
						chars: function(e) {
							if (r && (!X || 'textarea' !== r.tag || r.attrsMap.placeholder !== e)) {
								...
								if (
									(e =
										s || e.trim()
											? 'script' === (t = r).tag || 'style' === t.tag ? e : Wo(e)
											: o && i.length ? ' ' : '')
								)
									!a &&
									' ' !== e &&
									(n = (function(e, t) {
										...
										if (n.test(e)) {
											for (
												...
												(i = r.index) > u &&
													(s.push((o = e.slice(u, i))), a.push(JSON.stringify(o)));
												var c = gr(r[1].trim());
												a.push('_s(' + c + ')'),
													s.push({ '@binding': c }),
													(u = i + r[0].length);
										...
										? i.push({ type: 2, expression: n.expression, tokens: n.tokens, text: e })
				...
				!(function(e) {
					...
					(function(e) {
						if ('slot' === e.tag) e.slotName = Cr(e, 'name');
							...
							var t;
							'template' === e.tag
								? ((t = Ar(e, 'scope')), (e.slotScope = t || Ar(e, 'slot-scope')))
								: (t = Ar(e, 'slot-scope')) && (e.slotScope = t);
							var n = Cr(e, 'slot');
							n &&
				...
				!(function(e) {
					...
					for (t = 0, n = u.length; t < n; t++) {
						if (((r = i = u[t].name), (o = u[t].value), jo.test(r)))
							if (((e.hasBindings = !0), (a = Ko(r)) && (r = r.replace(Fo, '')), Mo.test(r)))
								(r = r.replace(Mo, '')),
									(o = gr(o)),
									(s = !1),
									a &&
										(a.prop && ((s = !0), 'innerHtml' === (r = E(r)) && (r = 'innerHTML')),
										a.camel && (r = E(r)),
				...
				return t.for && !t.forProcessed
					...
					: '{key:' +
						...
						('function(' +
							...
							('template' === t.tag
								? t.if
									? '(' + t.if + ')?' + (Ta(t, n) || 'undefined') + ':undefined'
									: Ta(t, n) || 'undefined'
								: ga(t, n)) +
							'}') +
						'}';
			...
			function La(e) {
				return (
					((Ia = Ia || document.createElement('div')).innerHTML = e ? '<a href="\n"/>' : '<div a="\n"/>'),
			...
			[
				function() {
					...
					return t('div', { staticClass: 'container' }, [
						t('div', { staticClass: 'row justify-content-center' }, [
							t('div', { staticClass: 'col-md-8' }, [
								t('div', { staticClass: 'card' }, [
									t('div', { staticClass: 'card-header' }, [ this._v('Example Component') ]),
									this._v(' '),
